...
train_X_transform.to_csv('/home/tanya/Education/HW2_dvc_cicd/data/train_X_transform.csv', sep=';')
train_y_transform.to_csv('/home/tanya/Education/HW2_dvc_cicd/data/train_y_transform.csv', sep=';')
test_X_transform.to_csv('/home/tanya/Education/HW2_dvc_cicd/data/test_X_transform.csv', sep=';')
test_y_transform.to_csv('/home/tanya/Education/HW2_dvc_cicd/data/test_y_transform.csv', sep=';')